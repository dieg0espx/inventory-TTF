...
function PrintableSheet() {
  ...
  function printSheet(){
    ...
    // window.open('./#/sheet?' + window.location.toString().split('?')[1])
  }
  ...
  const reloadIframe = () => {
    ...
    <div className='container'>
      ...
      <button className='btnPrint' onClick={()=>printSheet()}><i className="bi bi-printer"></i></button>
      <iframe src={sheetUrl} ref={iframeRef}></iframe>
    </div>
    )
}
